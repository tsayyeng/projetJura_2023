                ...
                <div class="col-12 col-md-9 col-lg-7 col-xl-6">
                    <div class="card" style="border-radius: 15px;">
                        <div class="card-body p-5">
                            ...
                            <?php
                            if (isset($_REQUEST['identifiant'], $_REQUEST['mail'], $_REQUEST['mdp'])) {

                                // récupérer le nom d'utilisateur
                                $nomClient = stripslashes($_REQUEST['nomClient']);
                                $nomClient = mysqli_real_escape_string($link, $nomClient);

                                // récupérer le prenom d'utilisateur
                                $prenomClient = stripslashes($_REQUEST['prenomClient']);
                                $prenomClient = mysqli_real_escape_string($link, $prenomClient);
                                ...
                                $query = "INSERT into client (nomClient, prenomClient, identifiant, mdp, mail)
				VALUES ('$nomClient', '$prenomClient', '$identifiant','" . hash('sha256', $mdp) . "', '$mail')";
                            ...
                            ?>
                                <form>
                                    ...
                                    <div class="form-outline mb-4">
                                        <input type="text" class="form-control form-control-lg" name="nomClient" placeholder="Nom" required />
                                    </div>

                                    <div class="form-outline mb-4">
                                        <input type="text" class="form-control form-control-lg" name="prenomClient" placeholder="Prenom" required />
